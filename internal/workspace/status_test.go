...
func TestStatusWithData(t *testing.T) {
	...
	w.NewSpec(NewSpecInput{Title: "Tech spec", Type: "functional", Summary: "a technical spec"})
	...
	if result.Specs.Functional != 1 {
		t.Errorf("specs technical = %d", result.Specs.Functional)
	}
