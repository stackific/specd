...
func TestSearchSpecsBM25(t *testing.T) {
	...
	w.NewSpec(NewSpecInput{Title: "User authentication", Type: "functional", Summary: "Login and session management"})
...
func TestSearchTrigramFallback(t *testing.T) {
	...
	w.NewSpec(NewSpecInput{Title: "The xyzfoo handler", Type: "functional", Summary: "Handles xyzfoo requests"})
...
func TestSearchWithFTSOperators(t *testing.T) {
	w := setupWorkspace(t)
	w.NewSpec(NewSpecInput{Title: "OAuth Authentication", Type: "functional", Summary: "OAuth auth flow"})
	w.NewSpec(NewSpecInput{Title: "Database Schema", Type: "functional", Summary: "DB design"})
...
func TestSearchQuotedPhrase(t *testing.T) {
	w := setupWorkspace(t)
	w.NewSpec(NewSpecInput{Title: "OAuth Flow Design", Type: "functional", Summary: "OAuth flow"})
