...
func TestInitDB(t *testing.T) {
	...
	_, err = db.Exec(`INSERT INTO specs
		(id, title, type, summary, body, path, content_hash, created_at, updated_at)
		VALUES ('SPEC-1', 'Test', 'business', 's', 'b', 'p', 'h', '2025-01-01', '2025-01-01')`)
	if err != nil {
	...
	_, err = db.Exec(`INSERT INTO specs
		(id, title, type, summary, body, path, content_hash, created_at, updated_at)
		VALUES ('SPEC-2', 'Bad', 'invalid_type', 's', 'b', 'p', 'h', '2025-01-01', '2025-01-01')`)
	if err == nil {
	...
	_, err = db.Exec(`INSERT INTO tasks
		(id, spec_id, title, status, summary, body, path, content_hash, created_at, updated_at)
		VALUES ('TASK-1', 'SPEC-1', 'Test', 'backlog', 's', 'b', 'p', 'h', '2025-01-01', '2025-01-01')`)
	if err != nil {
	...
	_, err = db.Exec(`INSERT INTO tasks
		(id, spec_id, title, status, summary, body, path, content_hash, created_at, updated_at)
		VALUES ('TASK-2', 'SPEC-1', 'Bad', 'invalid_status', 's', 'b', 'p', 'h', '2025-01-01', '2025-01-01')`)
	if err == nil {
